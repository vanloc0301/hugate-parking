namespace Hugate.Camera
{
    ...
    public class Configuration
    {
        ...
        public Camera GetCameraByName(string name)
        {
            ...
            return cameras.GetCameraSingle(name);
        }
        ...
        public View GetViewByName(string name)
        {
            ...
            return views.GetViewSingle(name);
        ...
        public void LoadCameras(string name, string id, string desc, string provider, string source, string login, string password, string size, string stype, string quality, string interval)
        {
            // create new camera
            Camera camera = new Camera(name);
            camera.ID = int.Parse(id);
            camera.Description = desc;
            camera.Provider = providers.GetProviderByName(provider);

            // load configuration
            if (camera.Provider != null)
                camera.Configuration = camera.Provider.LoadConfiguration(source, login, password, size, stype, quality, interval);
